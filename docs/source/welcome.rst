...
has a companion library written in C++,
`ataraxis-transport-layer-mc <https://github.com/Sun-Lab-NBB/ataraxis-transport-layer-mc>`_, intended for Arduino and
Teensy microcontrollers participating in the serialized communication over the transport layer.
